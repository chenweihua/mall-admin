package com.mall.admin.model.pagination;
...
import com.mall.admin.model.dialect.Dialect;
			...
			if (mappedStatement.getId().matches(paginationSqlRegEx)) {
				...
				if (parameterObject != null) {
					...
					if (parameterObject instanceof Map<?, ?>) {
						paginationInfo = (PaginationInfo) ((Map<?, ?>) parameterObject)
								.get("paginationInfo");
						...
						if (pageField != null) {
							...
							throw new NoSuchFieldException(parameterObject.getClass()
									.getName() + "不存在 PaginationInfo 属性");
						}
					}
