...
import com.mall.admin.service.taobao.api.Constants;
...
public class TaobaoLogger {
	 ...
	 * 通讯错误日志
	 */
	public static void logCommError(Exception e, HttpURLConnection conn, String appKey, String method,
			byte[] content) {
		if (!needEnableLogger) {
			return;
		}
	 ...
	 * 通讯错误日志
	 */
	private static void logCommError(Exception e, HttpURLConnection conn, String appKey, String method,
			String content) {
	 ...
	 * 通讯错误日志
	 */
	private static void _logCommError(Exception e, HttpURLConnection conn, String url, String appKey,
	 ...
	 * 发生特别错误时记录完整错误现场
	 */
	public static void logErrorScene(RequestParametersHolder context, TaobaoResponse tRsp, String appSecret) {
		if (!needEnableLogger) {
			return;
		}
		DateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
