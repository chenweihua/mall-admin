	...
	<div class="box col-md-12">
		<div class="box-inner">
			<div class="box-header well" data-original-title="">
				<h2>
					<i class="glyphicon glyphicon-banner"></i> 广告管理
				</h2>
		        ...
		        <div class="row">
			        ...
			        <div class="col-lg-2">
			         ...
			         <div class="col-lg-3" style="width:50%;">
			            <div class="input-group">
			              <span class="input-group-addon">banner标题或链接</span> 
			              <input type="text" id="contentOrLinkQuery" class="form-control" value="${contentOrLinkQuery}" placeholder="请输入banner标题或链接进行搜索...">
			            </div>
			          </div>
			...
			<div class="box col-md-12">
					<div class="box-content">
						<form role="form" id="form1">
							...
							<input type="hidden" name="subscribeType" value="isAdvertise" />
							<div class="form-group">
								<label for="title" class="control-label">banner标题:</label> 
								<input name="title" id="title" value="${subscribeDetail.title}" placeholder="">
							</div>
							
							<div class="form-group">
								<label for="subTitle" class="control-label">链接:</label>
...
$('#btnSubmitEdit').click(function(){
	...
	$.post(urlPrefix+"save?statusEdit="+statusEdit+"&contentTypeEdit="+contentTypeEdit, $("#form1").serialize(), function(response){
		if (response.code == 0) {
			alert("操作成功");
			$("#form1")[0].reset();
			clearAll();
